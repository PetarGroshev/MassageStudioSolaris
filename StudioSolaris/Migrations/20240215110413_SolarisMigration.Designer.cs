...
namespace StudioSolaris.Migrations
{
    ...
    [Migration("20240215110413_SolarisMigration")]
    partial class SolarisMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudioSolaris.Data.ServiceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudioSolaris.Data.Specialist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StudioSolaris.Data.Client", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudioSolaris.Data.Reservation", b =>
                {
                    ...
                    b.HasOne("StudioSolaris.Data.Service", "Services")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("StudioSolaris.Data.Service", b =>
                {
                    ...
                    b.HasOne("StudioSolaris.Data.Specialist", "Specialists")
                        .WithMany("Services")
