...
namespace StudioSolaris.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SpecialistsId"] = new SelectList(_context.Specialists, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,ServiceTypesId,Decription,SpecialistsId,ImageUrl,Price,DateAdded")] Service service)
        {
            ...
            ViewData["SpecialistsId"] = new SelectList(_context.Specialists, "Id", "Name", service.SpecialistsId);
            return View(service);
        }
